...
function um_upgrade_update_users_per_page20beta1() {
	...
	if ( ! empty( $_POST['key_in_meta'] ) && ! empty( $_POST['role_key'] ) && ! empty( $_POST['page'] ) ) {
		...
		$from = ( sanitize_key( $_POST['page'] ) * $users_per_page ) - $users_per_page + 1;
		$to = sanitize_key( $_POST['page'] ) * $users_per_page;
...
function um_upgrade_update_forum_per_page20beta1() {
	...
	if ( ! empty( $_POST['page'] ) ) {
		...
		$from = ( sanitize_key( $_POST['page'] ) * $posts_per_page ) - $posts_per_page + 1;
		$to = sanitize_key( $_POST['page'] ) * $posts_per_page;
